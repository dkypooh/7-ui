    ...
    <div class="block">
      ...
      <el-row :gutter="20">
        ...
        <el-col :span="15" class="nav-demos">
          <img src="/doc/assets/images/navbar_1.png" alt="一级类目" @click="enlarge(846, $event)">
          <h5>一级类目</h5>
          <p>适用于结构简单的网站：只有一级页面时，不需要使用面包屑。</p>
          <img src="/doc/assets/images/navbar_2.png" alt="二级类目" @click="enlarge(846, $event)">
          <h5>二级类目</h5>
          <p>侧栏中最多可显示两级导航；当使用二级导航时，我们建议搭配使用面包屑，方便用户定位自己的位置和快速返回。</p>
          <img src="/doc/assets/images/navbar_3.png" alt="三级类目" @click="enlarge(846, $event)">
          <h5>三级类目</h5>
    ...
    <div class="block">
      ...
      <el-row>
        ...
        <el-col :span="14" class="nav-demos">
          <img src="/doc/assets/images/navbar_0.png" alt="" @click="enlarge(846, $event)">
