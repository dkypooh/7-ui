...
<template>
  <div>
    ...
    <el-row :gutter="14" class="cards">
      <el-col :span="6">  
        <div class="card">
          <img src="/doc/assets/images/consistency.png" alt="Consistency">
          <h4>一致</h4>
      ...
      <el-col :span="6">  
        <div class="card">
          <img src="/doc/assets/images/feedback.png" alt="Feedback">
          <h4>反馈</h4>
          <span>Feedback</span>
        </div>
      </el-col>
      <el-col :span="6">  
        <div class="card">
          <img src="/doc/assets/images/efficiency.png" alt="Efficiency">
          <h4>效率</h4>
      ...
      <el-col :span="6">  
        <div class="card">
          <img src="/doc/assets/images/controllability.png" alt="Controllability">
          <h4>可控</h4>
